<?php 
    ...
    $result = $scss->compile('@import"app/scss/28.scss"');
    
    file_put_contents("app/css/28.css",$result);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $url_path ?>/app/css/28.css">
    ...
    <title>Modul 28</title>
</head>

<body>
    <?php
        include "28_Content.php";
    ?>
</body>
